...
function renderBracket(bracketCode) {
  return app.render('bracket', 'layouts/empty', validator.validateTournament(bracketCode, editable || editable(), false, getCurrentCode()));
}
...
function renderEditable() {
  this.res.writeHead(200, {"Content-Type": "text/html"});
  this.res.end(app.render('index', '', { bracketDisplay: renderBracket(getEmptyCode(), editable), editable: true }));
}
