...
function renderTemplate(bodyPath, layoutPath, context, templateId) {
  
  var bracketId = templateId;
  
  if(bracketId) {
    if(bracketCache.hasOwnProperty(bracketId)) {
      return bracketCache[bracketId];
    }
  }
