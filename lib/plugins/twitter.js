var util = require('util'),
    ...
    twitter_keys = {},
    old_tweets = require('../data/catchup-tweets.json').tweets;
...
function validateTweet(data) {
  ...
  console.log('#tybrkt found', validHash, tweetDate);
...
_.each(old_tweets, function(tweetId) {
  twit.get('/statuses/show/'+tweetId+'.json', {include_entities:true}, function(data) {
    validateTweet(data);
  });
});
