...
query = client.query('CREATE TABLE brackets (username varchar(50) NOT NULL, bracket varchar(140) NOT NULL, score integer DEFAULT 0, userid varchar(25) NOT NULL, tweetid varchar(25) PRIMARY KEY, created timestamptz NOT NULL)');
  ...
  stream.on('data', function(data) {
    ...
    if (validHash && Date.compare(tweetDate, stopTime) === -1) {
      ...
      pg.connect(process.env.DATABASE_URL, function(err, client) {
        if (!err) {
          console.log('inserting', validData);
