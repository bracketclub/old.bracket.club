...
export const sync = createSelector(me, ($me) => $me.syncing)

export const id = createSelector(me, ($me) => $me.id)

export const authenticating = createSelector(me, ($me) => $me.authenticating)

export const friends = createSelector(me, ($me) => $me.friends)

export const isAuthed = createSelector(id, ($id) => !!$id)

export const notAuthed = createSelector(id, ($id) => !$id)
