...
const urlIndex = (state, props) =>
  parseInt(qs.parse(props.location.search).game, 10)
...
export const index = createSelector(urlIndex, lastIndex, ($index, $lastIndex) =>
  isNaN($index) ? $lastIndex : Math.min($index, $lastIndex)
)
