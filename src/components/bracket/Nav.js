      ...
      <ButtonToolbar className="bracket-nav">
        <ButtonGroup>
          ...
          <Button
            bsStyle="default"
            disabled={!canGoBack}
            onClick={() => onNavigate('goToPrevious')}
          >
        ...
        {canManipulate && (
          <ButtonGroup>
            ...
            <Button bsStyle="default" onClick={() => onGenerate('lower')}>
              1
            </Button>
            <Button bsStyle="default" onClick={() => onGenerate('higher')}>
              16
            </Button>
