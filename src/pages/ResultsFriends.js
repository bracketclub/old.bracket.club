...
const mapStateToProps = mapSelectorsToProps({
  entries: entriesSelectors.friendsScoredByEvent,
  sortParams: entriesSelectors.sortParams,
  sync: mergeSyncState(entriesSelectors, mastersSelectors, meSelectors)
});
...
export default class ResultsFriendsPage extends Component {
  static propTypes = {
  ...
  static getEventPath = (e, params, query) => ({pathname: `/${e}/entries/friends`, query});
