          ...
          <FormGroup>
            <Col xs={12}>
              ...
              <p className="text-center margin-collapse">
                There’ll be gifs, emoji, announcements of cool new features, and
                you’ll be the first to know every time entries go live.
                <br className="visible-md-block visible-lg-block" /> Check out{' '}
                <a
                  href="http://us5.campaign-archive2.com/home/?u=3357cbc15c95f163a6fff3a84&id=2259ac644a"
                  target="_blank"
                  rel="noopener noreferrer"
                >
